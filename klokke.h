...
PIN_PB0, PIN_PE6, PIN_PE2, PIN_PF1, PIN_PF3, PIN_PF5, PIN_PF7, PIN_PA1  // r0 (CN1 on the silkscreen)
PIN_PE7, PIN_PE3, PIN_PF0, PIN_PF2, PIN_PF4, PIN_PF6, PIN_PA0, PIN_PA2, // r1 (CN2 on the silkscreen)
PIN_PD7, PIN_PD5, PIN_PD3, PIN_PD0, PIN_PG3, PIN_PB6, PIN_PB4, PIN_PB2, // r2 (CN3 on the silkscreen)
PIN_PD6, PIN_PD4, PIN_PD2, PIN_PG4, PIN_PB7, PIN_PB5, PIN_PB3, PIN_PB1, // r3 (CN4 on the silkscreen)
PIN_PA3, PIN_PA5, PIN_PA7, PIN_PC7, PIN_PC5, PIN_PC3, PIN_PC1, PIN_PG1, // r4 (CN5 on the silkscreen)
PIN_PA4, PIN_PA6, PIN_PG2, PIN_PC6, PIN_PC4, PIN_PC2, PIN_PC0, PIN_PG0, // r5 (CN6 on the silkscreen)
};
